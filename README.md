...
> **Public preview:** Lumina v0.1.0 is the first public Windows release. The
...
Download `install_Lumina-0.1.0.exe` from the
...
Lumina v0.1.0 is a local, single-user Windows application. It does not provide
